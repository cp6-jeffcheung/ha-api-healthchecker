...
export const ChartSection = ({
  ...
  if (!statusCodeCounts) {
    alert(statusCodeCounts)
    return null; // Return null if chartData is null
  }
...
export const EnvironmentSelector = ({
  ...
  handleStartClick,
  handleResetClick, // Add handleResetClick function
  theme,
}) => (
  <Paper
    elevation={3}
  ...
  >
    <Grid container spacing={3} alignItems="center">
      ...
      <Grid item xs={12} md={6}>
        ...
        <Button
          variant="contained"
          onClick={handleResetClick} // Call handleResetClick function
          disabled={selectedEnvironments.length === 0}
          sx={{
            height: "40px",
            borderRadius: 3,
